...
INVALID_SELECTION_ERROR_MESSAGE = "❌ Invalid selection, please try again ❌"
NO_ITEMS_FOUND_ERROR_MESSAGE = "Something went wrong 😞\nI couldn't detect clothing in that photo.\nPlease try again with another photo 📸"

### Buttons Text ###
NEXT_PRODUCT_BUTTON_TEXT = "Next product ➡️"
SEARCH_ANOTHER_ITEM_BUTTON_TEXT = "Search another item 🔄"
FOUND_ITEM_BUTTON_TEXT = "That's what I was looking for! 🎉"
NEW_UPLOAD_BUTTON_TEXT = "Never mind, let me upload a new photo 📸"
